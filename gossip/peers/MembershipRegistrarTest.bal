...
import static gossip.config.Config.DefaultValues.DEFAULT_SEED_NODES;
import static gossip.config.Config.KeyNames.LISTEN_PORT;
import static gossip.config.Config.KeyNames.SEED_NODES;
import static gossip.messages.MessageType.JOIN;
